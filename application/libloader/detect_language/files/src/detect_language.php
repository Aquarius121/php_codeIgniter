...
{
    public static function detect($input_str = "")
    {
        $clientID = 'absdfkj';
        $clientSecret = 'B1spz5BQnQt97TvKwGfr/j7BcVAakBfhIl2XMHIB+9c=';
        ...
        try{
            ...
            $detectMethodUrl = "http://api.microsofttranslator.com/V2/Http.svc/Detect?text=".urlencode($input_str);
