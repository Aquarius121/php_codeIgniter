<form method="post" id="selectable-form" action="admin/nr_builder/owler/bulk_build" name="selectable_form">
				...
				<div class="row-fluid">
					...
					<div class="span12">
						<div class="pull-right">
							...
							<a href="admin/nr_builder/owler/all?filter_search=CHECK_LOGO<?= 
								$vd->category_filter ?>">Check Logo</a> |

							<a href="admin/nr_builder/owler/all?filter_search=READY_TO_BUILD_NEWSROOMS<?= 
								$vd->category_filter ?>">Ready NRs</a> | 
							
							<a href="admin/nr_builder/owler/all?filter_search=ONLY_MISSING_LOGO_NEWSROOMS<?= 
								$vd->category_filter ?>">Logo Missing</a> | 

							<a href="admin/nr_builder/owler/all?filter_search=ONLY_MISSING_SOCIALS_NEWSROOMS<?= 
								$vd->category_filter ?>">Socials Missing</a> | 

							<a href="admin/nr_builder/owler/all?filter_search=MISSING_LOGO_N_SOCIALS_NEWSROOMS<?= 
								$vd->category_filter ?>">Socials&Logo Missng</a> | 

							<a href="admin/nr_builder/owler/all?filter_search=ONLY_MISSING_EMAIL_NEWSROOMS<?= 
								$vd->category_filter ?>">Email Missing</a> | 

							<a href="admin/nr_builder/owler/all?filter_search=DUPLICATE_EMAIL_NEWSROOMS<?= 
