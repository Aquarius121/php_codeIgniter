		...
		<div class="content content-no-tabs">
			...
			$(function(){
				$("#company_edit_form").submit(function() {
					...
					var url = "admin/nr_builder/newswire_ca/edit_save/<?= $vd->comp->id ?>";
					$.ajax({
							type: "POST",
							url: url,
				...
				update_parent_row = function(data){
					...
					{
						html = "<a href='admin/nr_builder/newswire_ca/build/"+comp_id+"'>Build NR</a>";
				...
				load_feedback = function(data){
					...
					$(".modal-content").animate({
						scrollTop: $("#feedback_area").offset().top},
						'slow');
				}
			});
