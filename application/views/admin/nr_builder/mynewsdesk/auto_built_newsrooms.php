<form method="post" id="selectable-form" action="admin/nr_builder/mynewsdesk/export_auto_built_nrs_to_csv">
	<div class="row-fluid">
		<div class="span12">
			<header class="page-header">
				<div class="row-fluid">
					<div class="span5">
						<h1>Auto Built NRs (MyNewsDesk)</h1>
					</div>
		...
		<div class="span12">
			<div class="content listing">
				<div class="row-fluid">
					...
					<div class="span12">
						<div class="span9 pad-15v">
							<div class="pull-right">
								<strong>Filter: </strong>
								<a href="admin/nr_builder/mynewsdesk/auto_built_nrs_not_exported">
									Not Exported to CSV
								</a> | 
								<a href="admin/nr_builder/mynewsdesk/auto_built_nrs_already_exported">
									Already Exported to CSV
								</a> | 
								<a href="admin/nr_builder/mynewsdesk/auto_built_nrs_already_existing">
									Already Existing NRs
								</a> | 
								<?php if (@$vd->not_exported): ?>
									<a href="admin/nr_builder/mynewsdesk/auto_built_nrs_not_exported?filter_lang=English">
										English NRs
									</a>
								<?php elseif (@$vd->already_exported): ?>
									<a href="admin/nr_builder/mynewsdesk/auto_built_nrs_already_exported?filter_lang=English">
										English NRs
									</a>
								<?php elseif (@$vd->already_existing_nrs): ?>
									<a href="admin/nr_builder/mynewsdesk/auto_built_nrs_already_existing?filter_lang=English">
										English NRs
									</a>
								<?php else: ?>
									<a href="admin/nr_builder/mynewsdesk/auto_built_newsrooms?filter_lang=English">
										English NRs
									</a>
								<?php endif ?>
								| 
								<?php if (@$vd->not_exported): ?>
									<a href="admin/nr_builder/mynewsdesk/auto_built_nrs_not_exported?filter_lang=Non-English">
										Non/Partial English
									</a>
								<?php elseif (@$vd->already_exported): ?>
									<a href="admin/nr_builder/mynewsdesk/auto_built_nrs_already_exported?filter_lang=Non-English">
										Non/Partial English
									</a>
								<?php elseif (@$vd->already_existing_nrs): ?>
									<a href="admin/nr_builder/mynewsdesk/auto_built_nrs_already_existing?filter_lang=Non-English">
										Non/Partial English
									</a>
								<?php else: ?>
									<a href="admin/nr_builder/mynewsdesk/auto_built_newsrooms?filter_lang=Non-English">
										Non/Partial English
									</a>
								<?php endif ?>
							</div>
							...
							<td class="left">
								...
								<ul class="marbot-20">
									<?php if (!empty($result->flag)): ?>
										<li><img src="<?= $result->flag ?>" alt="<?= $result->country ?>"
											title="<?= $result->country ?>" class="nomar pad-5h"></li>
									<?php endif ?>
								...
								<?php if (!empty($result->newsroom_url)): ?>
									<ul>
										...
										<li>
											<a href="admin/nr_builder/mynewsdesk/pull_nr_data/<?= $result->id ?>">
												Pull MND NR Data</a>
										</li>
										<?php else: ?>
										<li class="pad-5h">
