<div class="alert alert-danger clearfix" id="delete-confirm">
	<form method="post" action="admin/nr_builder/sales_agent/delete/<?= $vd->sales_agent_id ?>">
		<button class="pull-left btn btn-danger" 
			type="submit" name="confirm" value="1">
			Confirm Delete
		</button>
		<strong>Caution!</strong> You are about to delete the sales agent record shown below.
