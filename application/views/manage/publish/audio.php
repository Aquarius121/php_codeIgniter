	...
	<header>
		<div class="row">
			...
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-12 actions">
				<a href="manage/publish/audio/edit" class="btn btn-primary">Submit Audio</a>
			</div>
		</div>
	</header>
			...
			<div class="panel with-nav-tabs panel-default">
				<div class="panel-heading">
					<ul class="nav nav-tabs nav-activate tab-links ax-loadable" 
						...
						<li><a data-on="^manage/publish/audio/all" data-toggle="link" 
							href="manage/publish/audio/all">All</a></li>
						<li><a data-on="^manage/publish/audio/published" data-toggle="link" 
							href="manage/publish/audio/published">Published</a></li>
						<li><a data-on="^manage/publish/audio/scheduled" data-toggle="link" 
							href="manage/publish/audio/scheduled">Scheduled</a></li>
						<li><a data-on="^manage/publish/audio/draft" data-toggle="link" 
							href="manage/publish/audio/draft">Draft</a></li>
					</ul>
				</div>
									...
									<td class="left">
										...
										<ul class="actions">
											...
											<?php if (Auth::is_admin_online()): ?>
												<li><a href="manage/publish/audio/fork/<?= $result->id ?>">Fork</a></li>
												<?php endif ?>
								...
								<?php if (!count($vd->results)): ?>
									<tr>
										<td colspan="3" class="ta-left">
											...
											<a href="manage/publish/audio/edit">submit</a>
											one now.
										</td>
									</tr>
								<?php endif ?>
