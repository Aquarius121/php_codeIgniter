...
<div class="container-fluid">
	<header>
		<div class="row">
			<div class="col-lg-6 page-title">
				<?php if (@$vd->m_content): ?>
					<h2>Edit News Content (External/Backdated)</h2>
				<?php else: ?>
					<h2>Add News Content (External/Backdated)</h2>
				<?php endif ?>
			</div>
		</div>
	</header>
	...
	<div class="content">
		<form class="tab-content required-form has-premium" method="post" action="manage/publish/news/edit/save/external/<?= @$vd->m_content->id ?>" id="content-form">
