<?php $ci->title = 'Special Offer 25% Offer All Orders Today!'; ?>

<script> 

defer(function() {
	wait_for_document_load(); 
});
		...
		<div class="row">
			...
			<div class="col-sm-10">
				<header class="main-header">
					...
					<p>Build your brand and increase your visibility with <br />our easy and effective <strong>3 Step Process</strong>.</p>
				</header>
			</div>
			<div class="col-sm-1"></div>
		</div>
		...
		<div class="row">
			...
			<div class="col-md-8" id="tabs">
				...
				<ul class="nav nav-tabs">
					<li class="active"><a href="#press-release" data-toggle="tab">1. Press Release Distribution</a></li>				
					<li><a href="#media-outreach" data-toggle="tab">2. Media Outreach</a></li>
					<li><a href="#company-newsroom" data-toggle="tab">3. Company Newsroom</a></li>
				</ul>
					...
					<div class="tab-pane" id="media-outreach">
						<div class="tab-content-data">
							...
							<div class="col-sm-8">
								...
								<p>All Premium Features press releases include email credits that can be used to <a href="features/pitching">send pitches</a> to various media contacts. Use the provided template to easily import your email list to update them on the latest happenings at your company. We provide a seamless approach to press release distribution and press management.</p>
							</div>
							<div class="clearfix"></div>
						</div>
...
<div class="signup-today" style="margin-top: 0px">
	<h2>Get 25% Your Order Today Only. <br />Use the Code below:<strong><br /><br />GOOGLEAD25</strong></h2>
	<form class="form-inline" role="form" method="post" action="<?= $ci->website_url(null, true) ?>register/quick">
		<div class="form-group">
			<br /><br />
			<a href="pricing" class="signup-btn">Get Started Today!</a>
		</div>
	</form>
</div>

<script src="//cdn.optimizely.com/js/2026700629.js"></script>