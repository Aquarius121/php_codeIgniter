...
class Help {
	...
	/* aim: move this content to the views */
	...
	const WEB_IMAGES = 'Attach images to your content. 
		The featured image will be shown between the title and body text. 
		JPEG, GIF, and PNG formats are accepted. Maximum file size is 2MB.';
	...
	const SOCIAL_PROFILES = 'Include social media profiles in the sidebar.';
