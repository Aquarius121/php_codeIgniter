...
class Crawl_Company_Website_Controller extends Auto_Create_NR_Base {
	...
	public function get($c_data)
	{
		...
		$web_crawled = new Model_PR_Co_Website_Crawled();
		$web_crawled->pr_co_company_id = $c_data->pr_co_company_id;
		...
		$c_data = Model_PR_Co_Company_Data::find($c_data->pr_co_company_id);
