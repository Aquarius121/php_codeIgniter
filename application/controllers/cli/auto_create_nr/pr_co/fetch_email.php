...
class Fetch_Email_Controller extends Auto_Create_NR_Base {
	...
	public function get($c_data)
	{
		...
		$m_f_email = new Model_PR_Co_Fetch_Email();
		$m_f_email->pr_co_company_id = $c_data->pr_co_company_id;
		...
		{			
			...
			$this->update_pr_co_c_data($c_data->pr_co_company_id, $email);
			return;
		}
	...
	protected function update_pr_co_c_data($pr_co_company_id, $email)
	{
		$c_data = Model_PR_Co_Company_Data::find($pr_co_company_id);
		$c_data->email = $email;
