...
class Fetch_Contact_Us_URL_Controller extends Auto_Create_NR_Base {
	...
	public function index()
	{
		...
		$sql = "SELECT cd.*, cd.businesswire_company_id AS source_company_id
				...
				ORDER BY cd.businesswire_company_id DESC
				LIMIT 100";

		while (1)
		{
			$source = Model_Fetch_Contact_Us_URL::SOURCE_BUSINESSWIRE;
			$results = Model_BusinessWire_Company_Data::from_sql_all($sql, array($source));
