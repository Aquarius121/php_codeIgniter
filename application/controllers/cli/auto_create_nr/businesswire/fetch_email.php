...
class Fetch_Email_Controller extends CLI_Base {
	...
	public function get($c_data)
	{
		...
		$m_f_email = new Model_BusinessWire_Fetch_Email();
		$m_f_email->businesswire_company_id = $c_data->businesswire_company_id;
		...
		{	
			...
			$this->update_businesswire_c_data($c_data->businesswire_company_id, $email);
			return;
		}
	...
	protected function update_businesswire_c_data($businesswire_company_id, $email)
	{
		$c_data = Model_BusinessWire_Company_Data::find($businesswire_company_id);
		$c_data->email = $email;
		$c_data->save();
	}
