...
class News_Feed_Reader_Controller extends CLI_Base {
	...
	public function __construct()
	{
		...
		static::$_JOB_QUEUE = 'news-feed-reader';
	...
	public function index()
	{
		...
		$sql = "SELECT * FROM nr_company_profile WHERE company_id > ?
			AND is_enable_rss_news = 1
			AND rss_news_url IS NOT NULL
