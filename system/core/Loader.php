...
class CI_Loader {
	 ...
	 * @return	void
	 */
	protected function _ci_load($_ci_data, $_ci_test = false)
	{
		...
		else
		{
			...
			$_ci_file = ($_ci_ext != 'php') ? $_ci_view.'.php' : $_ci_view;
		...
		if ($_ci_test === true)
		{
			return $file_exists || file_exists($_ci_path);
		}
		...
		$buffer = ob_get_contents();
		@ob_end_clean();
		$_ci_CI->output->append_output($buffer);
	}
