...
class CI_DB_driver {
	...
	function escape($data)
	{
		if (is_object($data))
		{
			return "'" . $this->escape_str($data->__toString()) . "'";
		}
	...
	/* return instance of Query_Cache
	   but with a different default lifetime */
	function cached($lifetime = null)
	{
		if ($lifetime === null)
		     return $this->cached; // injected from CIL_Loader
		else return new Query_Cache($this, $lifetime);
	}
